...
pause_img = tk.PhotoImage(file= "pause-button-round-icon.png")
play_img = tk.PhotoImage(file= "play-button-round-icon.png")
next_img = tk.PhotoImage(file= "play-next-icon.png")
